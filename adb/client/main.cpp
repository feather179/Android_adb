...
int main(int argc, char* argv[], char* envp[]) {
    ...
    // if started from linker64, "/proc/self/exe" will leads to path of linke64
    std::string executable_path;
    android::base::Realpath(argv[0], &executable_path);
    adb_set_executable_path(executable_path);
