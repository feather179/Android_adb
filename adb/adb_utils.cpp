...
std::string adb_get_homedir_path() {
    ...
    return home_str;
#else
    return android::base::Dirname(adb_get_executable_path());
...
static std::string adb_executable_path = "";

void adb_set_executable_path(std::string path) {
    adb_executable_path = path;
}

std::string adb_get_executable_path() {
